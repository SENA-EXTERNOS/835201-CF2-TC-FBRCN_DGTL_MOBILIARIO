    ...
    ImagenInfograficaB.color-secundario.mb-5
      ...
      div(x="32%" y="66%" tooltip="Sketchup" numero="+")
        .row.justify-content-around.align-items-center
          ...
          .col-8.col-sm-6.col-md-9.mb-4.mb-md-0
            .h5.mb-2 Sketchup.
            p.mb-5 Es un modelador 3D; es decir, un #[em  software] destinado a la creación y desarrollo de modelos y diseños 3D. Su amplia variedad de recursos, permite elaborar múltiples formas y volúmenes para componer proyectos tridimensionales de ambientes y objetos más realistas e insertados en el contexto donde serán presentados o construidos en el mundo físico. Sketchup se ha convertido en una valiosa herramienta para arquitectos, ingenieros civiles, diseñadores de interiores, de exteriores y de productos o manufacturas, teniendo en cuenta que sus modelos 3D optimizan la presentación comercial y ofrecen una mejor percepción visual a clientes y consumidores.
              br
              |En Sketchup el usuario puede descargar varios modelos 3D de productos del mundo real, desde la biblioteca de Sketchup (3D Warehouse) se encuentra una gran variedad de ítems de mobiliario, iluminación, decoración, elementos de oficina, entre otros. Con la inclusión de estos objetos, es posible crear ambientes realistas, incluso sin contar con las herramientas de la versión profesional.
